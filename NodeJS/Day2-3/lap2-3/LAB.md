...
```typescript
import { z } from "zod";
import { IGeneralSchema } from "../types";

const mongoIdRegex = /^[0-9a-fA-F]{24}$/;

export const createPostSchema: IGeneralSchema = {
    body: z.object({
...
```typescript
export const getUserByIdSchema: IGeneralSchema = {
    params: z.object({
        id: z.string().regex(mongoIdRegex, "Invalid user ID format")
    })
};

export const updateUserSchema: IGeneralSchema = {
    params: z.object({
        id: z.string().regex(mongoIdRegex, "Invalid user ID format")
    }),
    body: z.object({
...
export const deleteUserSchema: IGeneralSchema = {
    params: z.object({
        id: z.string().regex(mongoIdRegex, "Invalid user ID format")
    })
};
